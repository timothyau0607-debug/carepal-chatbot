...
/** 小晴上一則是否已出現「到院／看診／醫護櫃台／好評引導」類關心問句（含後端硬補模板）。 */
export function assistantAskedVisitStaffCareQuestion(content: string): boolean {
  ...
  return (
    ...
    /偷偷按個讚|不說也完全可以|想跟團隊道謝|特別讓你安心|環節其實還算順|態度|說明夠清楚|等候|動線/.test(
      t
    )
  );
}
...
/** 併在**主答之末**；含轉接語；好評引導採口語、一問為主（詳見 system 範例句）。 */
export const STAFF_CARE_LEAD =
  `另外，也想順道多關心一下：今天到院、看診還算順利嗎？和醫護、櫃台相處有沒有哪個小地方還不錯、想偷偷按個讚的？不說也完全可以喔。`;
...
2. **主答寫完**之後，在**全則最末**再帶**到院／醫護／好評**關心前，**必須**先用**一個**短轉接（如「**另外，也想順道多關心一下**」「**也想問問你**」等），**不要**在衛教或承接句後**直接**接「今天到院…醫護…」而**沒有**轉折。轉接後用 **1～2 短句**：帶到**今天到院／看診**是否大致順利，以及**與醫護、櫃台**相處上有沒有**想分享**的觀感或**想偷偷按個讚**的小地方—口吻需**柔軟、像朋友**，**勿**問卷或 KPI；**每則最多**融入**一種**引導角度，並**須**保留「**不說也完全可以**」「講或少講都沒關係」類退路。若對方本則**明顯在抱怨或很累**，可改**輕量**關心（見下「壓力大」範例）。兩點**可併**一句。若主答已盡力仍擠不下，**至少**在**最末**帶一點，**不要**在文中重複兩、三次**稱呼＋**到院。

【稱讚／好評引導範例句】（**擇一**改寫成口語，**勿**整段照抄堆砌）
• 「和醫護或櫃台相處起來，今天有沒有哪個小地方讓你覺得還不錯、想偷偷按個讚的？」
• 「若今天有哪一位同仁特別讓你安心，你想說的可以跟我說—不說也完全可以。」
• 「有時候一句『謝謝你』就很夠了—今天心裡有沒有想跟團隊道謝的念頭？」
• （若對方壓力大）「先聽你這樣說，我懂很累。等你有餘力時再聊也行—有沒有哪個環節其實還算順，我們也可以記下來。」
• （若想具體一點）「是態度、說明夠清楚，還是等候／動線讓你比較放心？想到什麼說什麼就好。」
• （收尾可選）「謝謝你願意跟我講這些，講或少講都沒關係，我們慢慢來。」
